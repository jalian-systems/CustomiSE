...
public class Session {
    ...
    public Session(IJavaAgent agent) {
    ...
    public void window(String name) {
        agent.switchToWindow(name);
    }

    public void setTimeout(long millis) {
        agent.manageTimeoutsImplicitlyWait(millis, TimeUnit.MILLISECONDS);
    }
    ...
    public IJavaElement findElement(String using, String value) {
        if ("name".equals(using)) {
            ...
            return agent.findElementById(value);
        }
    ...
    public String execute(String script, JSONArray params, Session session, ExecuteMode mode) {
        return agent.execute(script, params, mode);
    }
