...
public class CalcOperationField implements IJavaElement {

    private char button;
    private BufferedReader reader;
    private PrintWriter writer;

    public CalcOperationField(BufferedReader reader, PrintWriter writer, char button) {
        this.reader = reader;
        this.writer = writer;
        this.button = button;
    }
